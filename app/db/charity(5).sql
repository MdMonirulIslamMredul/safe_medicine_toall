...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Sep 05, 2023 at 11:45 AM
...
CREATE TABLE IF NOT EXISTS `abouts` (
  ...
  `foundation_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `foundation_name_bangla` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `director_name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `director_name_bangla` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `foundation_image` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Table structure for table `lifetime_members`
--

DROP TABLE IF EXISTS `lifetime_members`;
CREATE TABLE IF NOT EXISTS `lifetime_members` (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `title` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `title_bangla` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `long_des_eng1` longtext COLLATE utf8mb4_unicode_ci,
  `long_des_eng2` longtext COLLATE utf8mb4_unicode_ci,
  `long_des_bangla1` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `long_des_bangla2` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
...
--
-- Dumping data for table `lifetime_members`
--

INSERT INTO `lifetime_members` (`id`, `title`, `title_bangla`, `long_des_eng1`, `long_des_eng2`, `long_des_bangla1`, `long_des_bangla2`, `video_link`, `created_at`, `updated_at`) VALUES
(3, 'As-Sunnah Foundation Mosque Complex', 'আস-সুন্নাহ ফাউন্ডেশন মসজিদ কমপ্লেক্স', '<div class=\"ant-typography\">Lifetime Member\', \'Donor Member\' and \'Square feet Donor\' are being collected as per Article 4 B and C of the constitution of As-Sunnah Foundation. Donor members, lifetime members and Square feet donors will be able to make any suggestions for the benefit of the Foundation. The one-time grant collected from the members of these two councils will be used for the construction of \'As-Sunnah Foundation Complex\'. Note that this is a Sadaqah Jariyah project, the reward of which will continue to be included in the record even after death In sha Allah.</div>\n<div class=\"ant-typography\">আস-সুন্নাহ ফাউন্ডেশনের&nbsp;<a href=\"https://assunnahfoundation.org/about/introduction\">নীতি ও আদর্শের</a>&nbsp;সঙ্গে একমত এরকম যে কেউ আজীবন সদস্য ও দাতা সদস্য হওয়ার জন্য আবেদন করতে পারবেন।</div>\n<div class=\"ant-typography\">\n<p>Lifetime Member</p>\nAll members who donate at least 100,000 / = (One Lakh) or more to the foundation fund for the foundation will become lifetime members of the foundation.</div>\n<div class=\"ant-typography\">\n<p>Donor Member</p>\nAll members who donate at least 50,000 / = (fifty thousand) or more to the foundation fund for the foundation, will be the donor members of the foundation.</div>\n<div class=\"ant-typography\">Donors and lifetime members will be the member of As-sunnah Foundation till death. In the interest of the Foundation, their advice will be sought as required and they will be informed about various activities from time to time.</div>\n<div class=\"ant-typography\">Membership rules:</div>\n<ul class=\"ant-timeline\">\n<li class=\"ant-timeline-item\">\n<div class=\"ant-timeline-item-tail\">&nbsp;</div>\n<div class=\"ant-timeline-item-head ant-timeline-item-head-green\">&nbsp;</div>\n<div class=\"ant-timeline-item-content\">All members of the foundation must follow the Qur\'an and Sunnah and be free from shirk (Polytheism) and bid\'at (Innovation).</div>\n</li>\n<li class=\"ant-timeline-item\">\n<div class=\"ant-timeline-item-tail\">&nbsp;</div>\n<div class=\"ant-timeline-item-head ant-timeline-item-head-green\">&nbsp;</div>\n<div class=\"ant-timeline-item-content\">Payment for membership fee must be halal.</div>\n</li>\n<li class=\"ant-timeline-item ant-timeline-item-last\">\n<div class=\"ant-timeline-item-head ant-timeline-item-head-green\">&nbsp;</div>\n<div class=\"ant-timeline-item-content\">Fill out the prescribed form.</div>\n</li>\n</ul>\n<div class=\"ant-typography\">Subject to the above conditions, any man or woman can become a donor or life member of As-Sunnah Foundation.</div>\n<div class=\"ant-typography\">Moreover, any amount of money can be donated for the establishment of the complex.</div>\n<div class=\"ant-typography\">For overall communication and cooperation 01408405060 (mobile, whatsapp, imo, telegram)</div>', '<div class=\"ant-typography\">Lifetime Member\', \'Donor Member\' and \'Square feet Donor\' are being collected as per Article 4 B and C of the constitution of As-Sunnah Foundation. Donor members, lifetime members and Square feet donors will be able to make any suggestions for the benefit of the Foundation. The one-time grant collected from the members of these two councils will be used for the construction of \'As-Sunnah Foundation Complex\'. Note that this is a Sadaqah Jariyah project, the reward of which will continue to be included in the record even after death In sha Allah.</div>\n<div class=\"ant-typography\">আস-সুন্নাহ ফাউন্ডেশনের&nbsp;<a href=\"https://assunnahfoundation.org/about/introduction\">নীতি ও আদর্শের</a>&nbsp;সঙ্গে একমত এরকম যে কেউ আজীবন সদস্য ও দাতা সদস্য হওয়ার জন্য আবেদন করতে পারবেন।</div>\n<div class=\"ant-typography\">\n<p>Lifetime Member</p>\nAll members who donate at least 100,000 / = (One Lakh) or more to the foundation fund for the foundation will become lifetime members of the foundation.</div>\n<div class=\"ant-typography\">\n<p>Donor Member</p>\nAll members who donate at least 50,000 / = (fifty thousand) or more to the foundation fund for the foundation, will be the donor members of the foundation.</div>\n<div class=\"ant-typography\">Donors and lifetime members will be the member of As-sunnah Foundation till death. In the interest of the Foundation, their advice will be sought as required and they will be informed about various activities from time to time.</div>\n<div class=\"ant-typography\">Membership rules:</div>\n<ul class=\"ant-timeline\">\n<li class=\"ant-timeline-item\">\n<div class=\"ant-timeline-item-tail\">&nbsp;</div>\n<div class=\"ant-timeline-item-head ant-timeline-item-head-green\">&nbsp;</div>\n<div class=\"ant-timeline-item-content\">All members of the foundation must follow the Qur\'an and Sunnah and be free from shirk (Polytheism) and bid\'at (Innovation).</div>\n</li>\n<li class=\"ant-timeline-item\">\n<div class=\"ant-timeline-item-tail\">&nbsp;</div>\n<div class=\"ant-timeline-item-head ant-timeline-item-head-green\">&nbsp;</div>\n<div class=\"ant-timeline-item-content\">Payment for membership fee must be halal.</div>\n</li>\n<li class=\"ant-timeline-item ant-timeline-item-last\">\n<div class=\"ant-timeline-item-head ant-timeline-item-head-green\">&nbsp;</div>\n<div class=\"ant-timeline-item-content\">Fill out the prescribed form.</div>\n</li>\n</ul>\n<div class=\"ant-typography\">Subject to the above conditions, any man or woman can become a donor or life member of As-Sunnah Foundation.</div>\n<div class=\"ant-typography\">Moreover, any amount of money can be donated for the establishment of the complex.</div>\n<div class=\"ant-typography\">For overall communication and cooperation 01408405060 (mobile, whatsapp, imo, telegram)</div>', '<article class=\"ant-typography\">\r\n<div class=\"ant-typography\">রাসূলুল্লাহ (সাল্লাল্লাহু আলাইহি ওয়া সাল্লাম)-এর মসজিদ সালাত আদায়ের পাশাপাশি বহুবিধ কল্যাণের কেন্দ্র ছিল। ঢাকা মসজিদের শহর হলেও বেশিরভাগ মসজিদে নামাযের জামায়াত এবং বড়জোর মকতবের মধ্যেই সীমাবদ্ধ। আস-সুন্নাহ ফাউন্ডেশন ঢাকায় একটি আদর্শ মসজিদ গড়ে তুলতে চায়, যা সালাত আদায় ছাড়াও বিভিন্ন কল্যাণমূলক কাজে মুখর থাকবে। এতে বিভিন্ন শ্রেণী-পেশা ও বয়সের মানুষের দীনি শিক্ষার নিয়মিত আয়োজন, প্রতি সপ্তাহের খুতবার সারসংক্ষেপ লিখিত আকারে মুসুল্লীদের মাঝে বিতরণ, প্রাজ্ঞ উলামায়ে কিরামের সাক্ষাৎ ও সান্নিধ্যলাভের সুযোগ, নারী ও শিশুদের জন্য বিশেষ কর্নার, দুস্থ রোগীদের বিনামূল্যে প্রাথমিক চিকিৎসা, পারিবারিক ও ব্যক্তিগত কলহ নিরসনকল্পে আলেমদের মাধ্যমে কাউন্সেলিংয়ের ব্যবস্থা ও গ্রাম থেকে বিভিন্ন সাময়িক প্রয়োজনে ঢাকায় আগত ব্যক্তিদের জন্য মুসাফিরখানাসহ বিভিন্ন কার্যক্রম থাকবে ইন-শা-আল্লাহ।</div>\r\n<div class=\"ant-typography\">এছাড়াও মসজিদের পাশে আস-সুন্নাহ ফাউন্ডেশনের দেশব্যাপী পরিচালিত যাবতীয় কল্যাণমূলক কাজের প্রধান কার্যালয় থাকবে ইন-শা-আল্লাহ। যেখান থেকে ফাউন্ডেশনের দেশব্যআপী পরিচালিত মসজিদ, মাদরাসা ও বিভিন্ন সেবা ও জনকল্যাণমূলক কাজ পরিচালিত হবে।</div>\r\n<div class=\"ant-typography\">যা থাকবে আস-সুন্নাহ ফাউন্ডেশন মসজিদ কমপ্লেক্সে ও ইসলামিক সেন্টারে :</div>\r\n</article>\r\n<ul class=\"ant-timeline\">\r\n<li class=\"ant-timeline-item\">\r\n<div class=\"ant-timeline-item-tail\">&nbsp;</div>\r\n<div class=\"ant-timeline-item-head ant-timeline-item-head-green\">&nbsp;</div>\r\n<div class=\"ant-timeline-item-content\">আদর্শ জামে মসজিদ</div>\r\n</li>\r\n<li class=\"ant-timeline-item\">\r\n<div class=\"ant-timeline-item-tail\">&nbsp;</div>\r\n<div class=\"ant-timeline-item-head ant-timeline-item-head-green\">&nbsp;</div>\r\n<div class=\"ant-timeline-item-content\">জেনারেল ও দীনি শিক্ষার সমন্বিত সিলেবাসের আধুনিক (অনাবাসিক) মাদরাসা</div>\r\n</li>\r\n<li class=\"ant-timeline-item\">\r\n<div class=\"ant-timeline-item-tail\">&nbsp;</div>\r\n<div class=\"ant-timeline-item-head ant-timeline-item-head-green\">&nbsp;</div>\r\n<div class=\"ant-timeline-item-content\">আস-সুন্নাহ ফাউন্ডেশনের প্রধান কার্যালয়</div>\r\n</li>\r\n<li class=\"ant-timeline-item\">\r\n<div class=\"ant-timeline-item-tail\">&nbsp;</div>\r\n<div class=\"ant-timeline-item-head ant-timeline-item-head-green\">&nbsp;</div>\r\n<div class=\"ant-timeline-item-content\">শরয়ী সমাধান বিভাগ</div>\r\n</li>\r\n<li class=\"ant-timeline-item\">\r\n<div class=\"ant-timeline-item-tail\">&nbsp;</div>\r\n<div class=\"ant-timeline-item-head ant-timeline-item-head-green\">&nbsp;</div>\r\n<div class=\"ant-timeline-item-content\">উচ্চতর ইসলামী গবেষণাকেন্দ্র</div>\r\n</li>\r\n<li class=\"ant-timeline-item\">\r\n<div class=\"ant-timeline-item-tail\">&nbsp;</div>\r\n<div class=\"ant-timeline-item-head ant-timeline-item-head-green\">&nbsp;</div>\r\n<div class=\"ant-timeline-item-content\">শিশু-কিশোরদের জন্য ইসলামী সংস্কৃতিকেন্দ্র</div>\r\n</li>\r\n<li class=\"ant-timeline-item\">\r\n<div class=\"ant-timeline-item-tail\">&nbsp;</div>\r\n<div class=\"ant-timeline-item-head ant-timeline-item-head-green\">&nbsp;</div>\r\n<div class=\"ant-timeline-item-content\">ইমাম ও খতীবদের জন্য দাওয়াহ প্রশিক্ষণকেন্দ্র</div>\r\n</li>\r\n<li class=\"ant-timeline-item\">\r\n<div class=\"ant-timeline-item-tail\">&nbsp;</div>\r\n<div class=\"ant-timeline-item-head ant-timeline-item-head-green\">&nbsp;</div>\r\n<div class=\"ant-timeline-item-content\">ফ্যামিলি কাউন্সেলিং বিভাগ</div>\r\n</li>\r\n<li class=\"ant-timeline-item\">\r\n<div class=\"ant-timeline-item-tail\">&nbsp;</div>\r\n<div class=\"ant-timeline-item-head ant-timeline-item-head-green\">&nbsp;</div>\r\n<div class=\"ant-timeline-item-content\">সমাজকল্যাণ পরিচালনা বিভাগ</div>\r\n</li>\r\n<li class=\"ant-timeline-item\">\r\n<div class=\"ant-timeline-item-tail\">&nbsp;</div>\r\n<div class=\"ant-timeline-item-head ant-timeline-item-head-green\">&nbsp;</div>\r\n<div class=\"ant-timeline-item-content\">পাবলিক লাইব্রেরি</div>\r\n</li>\r\n<li class=\"ant-timeline-item\">\r\n<div class=\"ant-timeline-item-tail\">&nbsp;</div>\r\n<div class=\"ant-timeline-item-head ant-timeline-item-head-green\">&nbsp;</div>\r\n<div class=\"ant-timeline-item-content\">আধুনিক মিডিয়া বিভাগ</div>\r\n</li>\r\n<li class=\"ant-timeline-item\">\r\n<div class=\"ant-timeline-item-tail\">&nbsp;</div>\r\n<div class=\"ant-timeline-item-head ant-timeline-item-head-green\">&nbsp;</div>\r\n<div class=\"ant-timeline-item-content\">বিনামূল্যে চিকিৎসাসেবা-কেন্দ্র</div>\r\n</li>\r\n<li class=\"ant-timeline-item ant-timeline-item-last\">\r\n<div class=\"ant-timeline-item-head ant-timeline-item-head-green\">&nbsp;</div>\r\n<div class=\"ant-timeline-item-content\">মুসাফিরখানা</div>\r\n</li>\r\n</ul>\r\n<article class=\"ant-typography\">\r\n<div class=\"ant-typography\">কমপ্লেক্স পরিচালনাধীন প্রতিষ্ঠান ও বিভাগসমূহ</div>\r\n<div class=\"ant-typography\">( কমপ্লেক্সে যেগুলোর শুধু কার্যালয় থাকবে। )</div>\r\n<div class=\"ant-typography\">০১. ইসলামিক স্কুল ও কলেজ</div>\r\n<ul class=\"ant-timeline\">\r\n<li class=\"ant-timeline-item ant-timeline-item-last\">\r\n<div class=\"ant-timeline-item-head ant-timeline-item-head-green\">&nbsp;</div>\r\n<div class=\"ant-timeline-item-content\">শিক্ষাক্ষেত্রে ভূমিকা রাখা আস-সুন্নাহ ফাউন্ডেশন প্রতিষ্ঠার অন্যতম মৌলিক উদ্দেশ্য। এই লক্ষ্য বাস্তবায়ন-কল্পে মাদরাসা প্রতিষ্ঠার পাশাপাশি আদর্শ ও নীতিবান নাগরিক গড়ে তোলার লক্ষ্যে ইসলামিক স্কুল ও কলেজ প্রতিষ্ঠিত হবে এবং কমপ্লেক্স থেকে পরিচালিত হবে ইন-শা-আল্লাহ।</div>\r\n</li>\r\n</ul>\r\n<div class=\"ant-typography\">০২. বেসিক ইসলাম ও কারিগরি শিক্ষাকেন্দ্র</div>\r\n<ul class=\"ant-timeline\">\r\n<li class=\"ant-timeline-item ant-timeline-item-last\">\r\n<div class=\"ant-timeline-item-head ant-timeline-item-head-green\">&nbsp;</div>\r\n<div class=\"ant-timeline-item-content\">তরুণ ও যুবকদেরকে ইসলাম-অনুরাগী ও দীনের মৌলিক জ্ঞান-সম্পন্ন হিসেবে গড়ে তোলার পাশাপাশি স্বাবলম্বী করে তোলা এই বিভাগের উদ্দেশ্য। আস-সুন্নাহ ফাউন্ডেশন দক্ষ প্রশিক্ষকের মাধ্যমে নারী ও পুরুষকে (আলাদাভাবে) কারিগরি প্রশিক্ষণ দান করে থাকে। একই সময়ে তাঁরা যাতে দ্বীনের মৌলিক জ্ঞান অর্জন করতে পারে, এজন্য তাঁদেরকে প্রখ্যাত ইসলামিক স্কলারদের মাধ্যমে ইসলামের মৌলিক বিধান শিক্ষাদান করা হয়। আস-সুন্নাহ ফাউন্ডেশন কমপ্লেক্সে এটিকে স্থায়ী ও প্রাতিষ্ঠানিক রূপ দেয়া হবে।</div>\r\n</li>\r\n</ul>\r\n<div class=\"ant-typography\">০৩. ইসলামী জ্ঞানের প্রতিযোগিতা বিভাগ</div>\r\n<ul class=\"ant-timeline\">\r\n<li class=\"ant-timeline-item ant-timeline-item-last\">\r\n<div class=\"ant-timeline-item-head ant-timeline-item-head-green\">&nbsp;</div>\r\n<div class=\"ant-timeline-item-content\">দীনি জ্ঞানচর্চার প্রতি শিশু-কিশোরসহ সকল শ্রেণী-পেশার মানুষকে উৎসাহিত করার লক্ষ্যে ইসলামী জ্ঞানের প্রতিযোগিতা অনুষ্ঠিত হয়। আস-সুন্নাহ কমপ্লেক্সে এটি স্বতন্ত্র বিভাগে আরো সুচারুরূপে পরিচালিত হবে ইন-শা-আল্লাহ।</div>\r\n</li>\r\n</ul>\r\n<div class=\"ant-typography\">০৪. ত্রাণ ও সমাজকল্যাণ পরিচালনা বিভাগ</div>\r\n<ul class=\"ant-timeline\">\r\n<li class=\"ant-timeline-item ant-timeline-item-last\">\r\n<div class=\"ant-timeline-item-head ant-timeline-item-head-green\">&nbsp;</div>\r\n<div class=\"ant-timeline-item-content\">মানবসেবা আস-সুন্নাহ ফাউন্ডেশন প্রতিষ্ঠার অন্যতম উদ্দেশ্য। ফাউন্ডেশন দীনদার দানশীল ব্যক্তিদের আর্থিক সহযোগিতায় আর্তমানবতার সেবায় নিয়মিত কাজ করে চলেছে। সারা বছর যাতে দুস্থ ও অসহায়দের কল্যাণার্থে এই কার্যক্রম পরিচালনা করা যায়, ত্রাণ ও সমাজকল্যাণ পরিচালনা বিভাগ সে লক্ষ্যে কাজ করবে। এই বিভাগ থেকে ইন-শা-আল্লাহ সুষ্ঠু, সুন্দর ও সুচারুরূপে সেবামূলক সকল কার্যক্রম পরিচালিত হবে।</div>\r\n</li>\r\n</ul>\r\n<div class=\"ant-typography\">০৫. আলেমদের স্বাবলম্বীকরণ প্রকল্প</div>\r\n<ul class=\"ant-timeline\">\r\n<li class=\"ant-timeline-item ant-timeline-item-last\">\r\n<div class=\"ant-timeline-item-head ant-timeline-item-head-green\">&nbsp;</div>\r\n<div class=\"ant-timeline-item-content\">ইমাম, মুয়াজ্জিন, খতীব ও তরুণ আলেমদের স্বাবলম্বী হিসেবে গড়ে তোলা এই প্রকল্পের উদ্দেশ্য। সম্মানিত আলেমগণ যাতে নিজেরা স্বাবলম্বী হয়ে দেশ, জাতি ও উম্মাহর নিঃস্বার্থ সেবা করতে পারেন, এজন্য তাঁদেরকে প্রশিক্ষণ দেয়া হবে এবং প্রয়োজনীয় উপকরণ প্রদান করা হবে। যে জাতীয় প্রশিক্ষণ দেয়া হবে: গ্রাফিক ডিজাইন, ওয়েব ডেভলপিং, আউটসোর্সিং, মৎসচাষ, পশুপালন, কৃষি ইত্যাদি।</div>\r\n</li>\r\n</ul>\r\n<div class=\"ant-typography\">০৬. এতিম, বিধবা ও স্বামী-পরিত্যাক্তা কেয়ার সেন্টার</div>\r\n<ul class=\"ant-timeline\">\r\n<li class=\"ant-timeline-item ant-timeline-item-last\">\r\n<div class=\"ant-timeline-item-head ant-timeline-item-head-green\">&nbsp;</div>\r\n<div class=\"ant-timeline-item-content\">এতিমদের দেখভাল, তাদের সুষ্ঠু বিকাশ ও পড়াশোনার দায়িত্ব এই শাখা থেকে পরিচালিত হবে। পাশাপাশি বিধবা ও স্বামী-পরিত্যাক্তা নারীদের অন্ন, বস্ত্র ও বাসস্থানের ব্যবস্থা করবে; এবং তাঁদেরকে বিভিন্ন কারিগরি বিষয়ে প্রশিক্ষিত করে স্বাবলম্বী করে তোলা হবে ইন-শা-আল্লাহ।</div>\r\n</li>\r\n</ul>\r\n</article>', '<p>সদস্য আহ্বান</p>\r\n<article class=\"ant-typography\">\r\n<div class=\"ant-typography\">আস-সুন্নাহ ফাউন্ডেশনের গঠনতন্ত্রের চার-এর খ ও গ ধারা মোতাবেক \'আজীবন সদস্য\', \'দাতা সদস্য\' ও \'স্কয়ারফিট ডোনার\' সংগ্রহ করা হচ্ছে। দাতা সদস্য, আজীবন সদস্য ও স্কয়ারফিট ডোনারগণ ফাউন্ডেশনের কল্যাণার্থে যে কোনো সুপরামর্শ দিতে পারবেন। এ দুটি পরিষদের সদস্যগণ থেকে সংগৃহীত এককালীন অনুদান \'আস-সুন্নাহ ফাউন্ডেশন কমপ্লেক্স\' মহাপ্রকল্প গড়ে তোলার কাজে ব্যয় করা হবে ইন-শা-আল্লাহ। উল্লেখ্য, এটি একটি সাদকায়ে জারিয়াহ প্রকল্প, যার সাওয়াব মৃত্যুর পরও আমলনামায় যুক্ত হতে থাকবে ইন শা আল্লাহ।</div>\r\n<div class=\"ant-typography\">আস-সুন্নাহ ফাউন্ডেশনের&nbsp;<a href=\"https://assunnahfoundation.org/about/introduction\">নীতি ও আদর্শের</a>&nbsp;সঙ্গে একমত এরকম যে কেউ আজীবন সদস্য ও দাতা সদস্য হওয়ার জন্য আবেদন করতে পারবেন।</div>\r\n<div class=\"ant-typography\">\r\n<p>আজীবন সদস্য</p>\r\nযারা ফাউন্ডেশনের কল্যাণার্থে এককালীন কমপক্ষে এক লক্ষ বা তদূর্ধ টাকা ফাউন্ডেশনের তহবিলে দান করবেন, তারা ফাউন্ডেশনের আজীবন সদস্য হবেন।</div>\r\n<div class=\"ant-typography\">\r\n<p>দাতা সদস্য</p>\r\nযারা ফাউন্ডেশনের কল্যাণার্থে এককালীন কমপক্ষে পঞ্চাশ হাজার বা তদূর্ধ টাকা ফাউন্ডেশনের তহবিলে দান করবেন, তারা ফাউন্ডেশনের দাতা সদস্য হবেন।</div>\r\n<div class=\"ant-typography\">দাতা ও আজীবন সদস্যগণ আমৃত্যু ফাউন্ডেশনের সদস্য থাকবেন। ফাউন্ডেশনের স্বার্থে প্রয়োজন অনুযায়ী তাঁদের পরামর্শ চাওয়া হবে এবং সময়ে সময়ে বিভিন্ন কার্যক্রম সম্পর্কে অবহিত করা হবে।</div>\r\n<div class=\"ant-typography\">সদস্য হওয়ার নিয়ম:</div>\r\n<ul class=\"ant-timeline\">\r\n<li class=\"ant-timeline-item\">\r\n<div class=\"ant-timeline-item-tail\">&nbsp;</div>\r\n<div class=\"ant-timeline-item-head ant-timeline-item-head-green\">&nbsp;</div>\r\n<div class=\"ant-timeline-item-content\">ফাউন্ডেশনের সকল সদস্যকে অবশ্যই কুরআন ও সুন্নাহর অনুসারী এবং শিরক ও বিদআত থেকে মুক্ত হতে হবে।</div>\r\n</li>\r\n<li class=\"ant-timeline-item\">\r\n<div class=\"ant-timeline-item-tail\">&nbsp;</div>\r\n<div class=\"ant-timeline-item-head ant-timeline-item-head-green\">&nbsp;</div>\r\n<div class=\"ant-timeline-item-content\">সদস্য ফি বাবদ প্রদেয় অর্থ হালাল হতে হবে।</div>\r\n</li>\r\n<li class=\"ant-timeline-item ant-timeline-item-last\">\r\n<div class=\"ant-timeline-item-head ant-timeline-item-head-green\">&nbsp;</div>\r\n<div class=\"ant-timeline-item-content\">নির্ধারিত ফরম পূরণ করতে হবে।</div>\r\n</li>\r\n</ul>\r\n<div class=\"ant-typography\">উপরিউক্ত শর্ত সাপেক্ষে যে কোনো নারী-পুরুষ আস-সুন্নাহ ফাউন্ডেশনের দাতা বা আজীবন সদস্য হতে পারবেন।</div>\r\n<div class=\"ant-typography\">তাছাড়া কমপ্লেক্স প্রতিষ্ঠায় সহযোগিতার নিমিত্তে সামর্থ অনুযায়ী যে কোনো পরিমাণ অর্থও দান করা যাবে।</div>\r\n<div class=\"ant-typography\">সার্বিক যোগাযোগ ও সহযোগীতার জন্য 01408405060 (mobile, whatsapp, imo, telegram)</div>\r\n</article>', '<iframe width=\"560\" height=\"315\" src=\"https://www.youtube.com/embed/2Hw_ipSCAOE?si=Tqa6-jOLbibw3KXc\" title=\"YouTube video player\" frameborder=\"0\" allow=\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\" allowfullscreen></iframe>', '2023-09-05 10:23:42', '2023-09-05 10:31:16');
...
--
-- Table structure for table `membership_forms`
--

DROP TABLE IF EXISTS `membership_forms`;
CREATE TABLE IF NOT EXISTS `membership_forms` (
  `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `memter_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `father_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Dumping data for table `membership_forms`
--

INSERT INTO `membership_forms` (`id`, `memter_type`, `name`, `father_name`, `phone_number`, `profession`, `email_address`, `reference`, `address`, `payment_method`, `created_at`, `updated_at`) VALUES
(1, 'Life time doner', 'International', 'Tomal Roy', '42343423', 'Engineer', 'dfdfd@gmail.com', 'Shadin', 'HOUSE-103, BLOCK-C, PARADISH PARL, BANGLADESH11', 'Banking', '2023-09-05 11:28:48', NULL);
...
(77, '2023_09_05_142906_create_volunteer_forms_table', 42),
(78, '2023_09_05_151149_create_lifetime_members_table', 43),
(79, '2023_09_05_171132_create_membership_forms_table', 44);
...
--
-- Table structure for table `volunteer_forms`
--
...
CREATE TABLE IF NOT EXISTS `volunteer_forms` (
  ...
  `email_address` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `facebook_id_link` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nid_number` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `education_qualifiction` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `profession` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `institute_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `summery` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `volunteer_section` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `skill` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `permanent_discrict` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `permanent_tikana` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `present_discrict` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `present_tikana` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Dumping data for table `volunteer_forms`
--

INSERT INTO `volunteer_forms` (`id`, `name`, `phone_number`, `emergency_phone_number`, `email_address`, `facebook_id_link`, `nid_number`, `education_qualifiction`, `profession`, `institute_name`, `summery`, `volunteer_section`, `skill`, `permanent_discrict`, `permanent_tikana`, `present_discrict`, `present_tikana`, `created_at`, `updated_at`) VALUES
(1, 'Jone Doe', '42343423', '34234324', 'dsff@gmail.com', 'https://www.facebook.com/login/', '32423423432454', 'Bsc', 'Engineer', 'Dhaka', 'dfsdfds', 'dsfdsertwer', 'ewrtdfdss', 'erwer', 'erwer', 'sdfsdf', 'dsfsdf', '2023-09-05 08:55:58', NULL),
(2, 'Jone Doe', '42343423', '34234324', 'dsff@gmail.com', 'https://www.facebook.com/login/', '32423423432454', 'Bsc', 'Engineer', 'Dhaka', 'dfsdfds', 'dsfdsertwer', 'ewrtdfdss', 'erwer', 'erwer', 'sdfsdf', 'dsfsdf', '2023-09-05 08:56:39', NULL);
