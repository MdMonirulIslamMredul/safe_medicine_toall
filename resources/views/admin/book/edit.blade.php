                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea  id="tinymce" class="editor form-control" col="10" row="3" name="des_en">{{ $book->des_en }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Book Details (BN)</label>
                                    <textarea  id="tinymce" class="editor form-control" col="10" row="3" name="des_bn">{{ $book->des_bn }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Book Details (AB)</label>
                                    <textarea  id="tinymce" class="editor form-control" col="10" row="3" name="des_ab">{{ $book->des_ab }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
