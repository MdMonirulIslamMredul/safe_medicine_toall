...
@section('body')
    <div class="row mt-2">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('booksubcategories.store') }}" method="POST">
                        @csrf
                ...
                <table id="config-table" class="table display table-striped border no-wrap">
                    ...
                    @foreach ($subcategories as $key => $subcategory)
                        <tr>
                            ...
                            <td>{{ $subcategory->bookCategory->category_name??null }}</td>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <div>
                                        <a href="{{ route('booksubcategories.edit', $subcategory->id) }}"
                                    ...
                                    <div>
                                        <form action="{{ route('booksubcategories.destroy', $subcategory->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
