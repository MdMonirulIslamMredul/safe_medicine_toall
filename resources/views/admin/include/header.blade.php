    ...
    <nav class="navbar top-navbar navbar-expand-md navbar-dark">
        ...
        <div class="navbar-header text-center">
            <a class="navbar-brand" href="">
                ...
                <img src="{{asset($logo->logo_image??null)}}" alt="homepage" height="80px" width="80px" class="dark-logo" />
                <!-- Light Logo icon -->
                <img src="{{asset($logo->logo_image??null)}}" alt="homepage" height="80px" width="80px"  class="light-logo" />
