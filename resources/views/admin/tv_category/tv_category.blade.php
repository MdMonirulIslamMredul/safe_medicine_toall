...
@section('body')
    <div class="row mt-2">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('tvcategories.store') }}" method="POST">
                        @csrf
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <div>
                                        <a href="{{ route('tvcategories.edit', $category->id) }}"
                                    ...
                                    <div>
                                        <form action="{{ route('tvcategories.destroy', $category->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
