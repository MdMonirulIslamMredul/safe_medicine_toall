    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-9 col-md-8 col-sm-6">
                <div class="row">
                    @forelse ($subcategory->audios as $audio)
                    <div class="col-lg-3 col-md-4">
                        <a href="{{ route('book.details', ['id' => $audio->id]) }}">
                            <div class="custom_card" style="padding: 5px; border-radius: 20px; margin-bottom: 30px;">
                                <img src="{{ asset('thumbnails/') }}/{{ $audio->thumbnil_img }}"
                                ...
                                {{-- <div class="text-center">
                                            <a class="btn btn-xs btn-theme-colored font-weight-600 font-11 flip mt-10"
                                                href="{{ route('book.details', ['id' => $audio->id]) }}">
                                @if (session()->get('language') == 'bangla')
                                বিস্তারিত দেখুন
                                @elseif (session()->get('language') == 'arabic')
                                عرض التفاصيل
                        ...
                        <a class="btn btn-xs btn-theme-colored font-weight-600 font-11 flip mt-10"
                            href="{{ asset('pdf_file') }}/{{ $audio->pdf_file }}"><i class="fa fa-file-pdf-o"
        ...
        <div class="custom_card" style="padding: 20px; border-radius: 20px; margin-bottom: 30px;">
            ...
            <div class="dropdown" style="margin: 2px 0">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                    ...
                    <li><a href="{{ route('subcategory.audio', ['id' => $subcategory->id]) }}">
                            @if (session()->get('language') == 'bangla')
                            {{ $subcategory->subcategory_name_ban }}
                            @elseif (session()->get('language') == 'arabic')
                            {{ $subcategory->subcategory_name_ab }}
