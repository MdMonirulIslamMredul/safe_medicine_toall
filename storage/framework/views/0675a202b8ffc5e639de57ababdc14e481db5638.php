...
<?php $__env->startSection('body'); ?>
    <div class="row mt-2">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form class="form-horizontal" action="<?php echo e(route('subcategories.update', $subcategory->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>">
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <option value="<?php echo e($category->id); ?>" <?php if($subcategory->category_id == $category->id): ?>
                                        selected
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($subcategory->subcategory_name); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            <label for="subcategory_name_ban">Subcategory Name Bangla</label>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($subcategory->subcategory_name_ban); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            <label for="subcategory_name_ab">Subcategory Name Arabic</label>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e($subcategory->subcategory_name_ab); ?>">
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\safe_medicine_toall\resources\views\admin\subcategory\edit.blade.php ENDPATH**/ ?>