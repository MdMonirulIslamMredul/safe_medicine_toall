...
<!-- Main content Start -->
 <div class="main-content">
    ...
    <?php echo $__env->make('frontend.enrollment.style_application', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <div id="content">
                    ...
                    <div class="row m-5 print-m-0">
                        <div class="col-12 bangla-font">
                            <form class="bv-validate-form form-center hide-success font-14 bv-form" method="POST"
                                action="<?php echo e(route('store.enrollment.form.data')); ?>" enctype="multipart/form-data">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-12 col-lg-10 col-xxl-8">
                                        ...
                                        <!-- Form Header start -->
                                            ...
                                            <div class="col-12 col-md-12">
                                                <div class="form-header text-center py-3 my-0" style="position: relative;">
                                                    ...
                                                    <h3 style="margin-bottom: 10px;color:red"><?php echo e($enrollment_info->institute_name); ?></h3>
                                                    <p style="margin-bottom: 0px;font-size:25px">( <?php echo e($enrollment_info->institute_address); ?> )</p>
                                                    <p style="font-size:25px"><?php echo e($enrollment_info->institute_owner); ?></p>
                                                </div>
                                            </div>
                                        ...
                                        <div class="d-block mt-2 mb-4 print-mb-2 lh-lg print-lh">
                                            ...
                                            <div>
                                                <?php echo $enrollment_info->institute_Instructions; ?>
                                        ...
                                        <!-- Row end -->
                                        <input type="text" name="service_id" id="" value="<?php echo e($service->id); ?>">
...
<?php echo $__env->make('frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\safe_medicine_toall\resources\views\frontend\enrollment\enrollment.blade.php ENDPATH**/ ?>