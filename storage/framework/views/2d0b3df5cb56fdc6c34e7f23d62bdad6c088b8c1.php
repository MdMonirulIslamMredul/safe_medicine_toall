        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-9 col-md-8">
                    <div class="row">
                        <?php $__empty_1 = true; $__currentLoopData = $subcategory->books; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                ...
                                <a href="">
                                    <div class="custom_card"
                                        ...
                                        <div class="text-center">
                                            ...
                                            <a class="btn btn-xs btn-theme-colored font-weight-600 font-11 flip mt-10"
                                                href="<?php echo e(asset('pdf_file')); ?>/<?php echo e($book->pdf_file); ?>"><i class="fa fa-file-pdf-o" aria-hidden="true" style="font-size: 15px"></i>
                                                <?php if(session()->get('language') == 'bangla'): ?>
                                                    ডাউনলোড করুন
                                                <?php elseif(session()->get('language') == 'arabic'): ?>
                                                    تحميل
...
<?php echo $__env->make('frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\safe_medicine_toall\resources\views\frontend\book\subcategory_book.blade.php ENDPATH**/ ?>