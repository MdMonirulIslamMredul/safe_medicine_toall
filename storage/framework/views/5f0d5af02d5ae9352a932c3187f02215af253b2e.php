...
<?php $__env->startSection('body'); ?>
    <div class="row mt-2">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form class="form-horizontal" action="<?php echo e(route('bookcategories.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <div>
                                        <a href="<?php echo e(route('bookcategories.edit', $category->id)); ?>"
                                    ...
                                    <div>
                                        <form action="<?php echo e(route('bookcategories.destroy', $category->id)); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\safe_medicine_toall\resources\views\admin\book_category\book_category.blade.php ENDPATH**/ ?>