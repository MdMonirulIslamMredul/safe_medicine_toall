...
<div class="row mt-2">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                <form class="form-horizontal" action="<?php echo e(route('update.donation.data')); ?>" enctype="multipart/form-data" method="POST">
                    <?php echo csrf_field(); ?>

                    <input type="hidden" value="<?php echo e($edit_donate_data->id); ?>" name="id">
                    <input type="hidden" value="<?php echo e($edit_donate_data->image); ?>" name="old_img">

                    <div class="form-group">
                        <label>Title</label>
                        <input type="text" name="title" class="form-control" value="<?php echo e($edit_donate_data->title); ?>">
                    </div>
                    <div class="form-group">
                        <label>Bangla Title</label>
                        <input type="text" name="bangla_title" class="form-control" value="<?php echo e($edit_donate_data->bangla_title); ?>">
                    </div>
                    <div class="form-group">
                        <label>Arabic Title</label>
                        <input type="text" name="arabic_title" class="form-control" value="<?php echo e($edit_donate_data->arabic_title); ?>">
                    </div>
                    <div class="form-group">
                        <label>Image</label>
                    ...
                    <div class="form-group">
                        <label>Video</label>
                        <textarea class="editor form-control" col="10" row="3" name="video_link" ><?php echo e($edit_donate_data->video_link); ?></textarea>
                    </div>
                    <div class="form-group">
                        <img src="<?php echo e(asset($edit_donate_data->image ) ?? null); ?>" style="height: 100px;">
                    </div>
                     <div class="form-group">
                        <label>Short Description-1 English</label>
                        <textarea id="tinymce" class="editor form-control" row="3" name="short_des1" >
                            <?php echo $edit_donate_data->short_des1; ?>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="tinymce" class="editor form-control" row="3" name="short_des2" >
                            <?php echo $edit_donate_data->short_des2; ?>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="tinymce" class="editor form-control" row="3" name="long_des1" >
                            <?php echo $edit_donate_data->long_des1; ?>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="tinymce" class="editor form-control" row="3" name="long_des2" >
                            <?php echo $edit_donate_data->long_des2; ?>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="tinymce" class="editor form-control" row="3" name="long_des3" >
                            <?php echo $edit_donate_data->long_des3; ?>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="tinymce" class="editor form-control" row="3" name="short_des_bangla1" >
                            <?php echo $edit_donate_data->short_des_bangla1; ?>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="tinymce" class="editor form-control" row="3" name="short_des_bangla2" >
                            <?php echo $edit_donate_data->short_des_bangla2; ?>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="tinymce" class="editor form-control" row="3" name="long_des_bangla1" >
                            <?php echo $edit_donate_data->long_des_bangla1; ?>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="tinymce" class="editor form-control" row="3" name="long_des_bangla2" >
                            <?php echo $edit_donate_data->long_des_bangla2; ?>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="tinymce" class="editor form-control" row="3" name="long_des_bangla3" >
                            <?php echo $edit_donate_data->long_des_bangla3; ?>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="tinymce" class="editor form-control" row="3" name="short_des_ab1" >
                            <?php echo $edit_donate_data->short_des_ab1; ?>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="tinymce" class="editor form-control" row="3" name="short_des_ab2" >
                            <?php echo $edit_donate_data->short_des_ab2; ?>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="tinymce" class="editor form-control" row="3" name="long_des_ab1" >
                            <?php echo $edit_donate_data->long_des_ab1; ?>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="tinymce" class="editor form-control" row="3" name="long_des_ab2" >
                            <?php echo $edit_donate_data->long_des_ab2; ?>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="tinymce" class="editor form-control" row="3" name="long_des_ab3" >
                            <?php echo $edit_donate_data->long_des_ab3; ?>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\safe_medicine_toall\resources\views\admin\donation\edit_donation_data.blade.php ENDPATH**/ ?>