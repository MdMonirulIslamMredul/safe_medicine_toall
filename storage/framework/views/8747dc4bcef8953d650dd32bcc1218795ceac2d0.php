...
<?php $__env->startSection('title'); ?>
    <?php if(session()->get('language') == 'bangla'): ?> মেডিসিন রিপোর্ট <?php else: ?> Unsafe Medicine Report <?php endif; ?>
...
<div class="umr-banner">
    <div class="container">
        ...
        <ul class="umr-breadcrumb">
            ...
            <li><?php if(session()->get('language') == 'bangla'): ?> মেডিসিন রিপোর্ট <?php else: ?> Unsafe Medicine Report <?php endif; ?></li>
        </ul>
    </div>
</div>
                ...
                <div class="umr-info-panel">
                    ...
                    <div class="umr-step">
                        ...
                        <div class="umr-step-body">
                            <h5><?php if(session()->get('language') == 'bangla'): ?> ফর্ম পূরণ করুন <?php else: ?> Fill the Form <?php endif; ?></h5>
                            <p><?php if(session()->get('language') == 'bangla'): ?> ওষুধ ও ফার্মেসির তথ্য দিন এবং প্রয়োজনে ছবি আপলোড করুন। <?php else: ?> Provide medicine &amp; pharmacy details, and upload evidence photos. <?php endif; ?></p>
                        </div>
                    </div>
                    ...
                    <div class="umr-step">
                        ...
                        <div class="umr-step-body">
                            <h5><?php if(session()->get('language') == 'bangla'): ?> ট্র্যাকিং নম্বর পান <?php else: ?> Get a Tracking Number <?php endif; ?></h5>
                            <p><?php if(session()->get('language') == 'bangla'): ?> জমা দেওয়ার পরপরই আপনাকে একটি অনন্য ট্র্যাকিং কোড দেওয়া হবে। <?php else: ?> After submission you instantly receive a unique tracking code. <?php endif; ?></p>
                        </div>
                    </div>
                    ...
                    <div class="umr-step">
                        ...
                        <div class="umr-step-body">
                            <h5><?php if(session()->get('language') == 'bangla'): ?> তদন্ত <?php else: ?> Investigation <?php endif; ?></h5>
                            <p><?php if(session()->get('language') == 'bangla'): ?> আমাদের দল রিপোর্টটি যাচাই করবে এবং প্রয়োজনীয় ব্যবস্থা নেবে। <?php else: ?> Our team verifies the report and takes necessary action. <?php endif; ?></p>
                        </div>
                    </div>
                    ...
                    <div class="umr-step">
                        ...
                        <div class="umr-step-body">
                            <h5><?php if(session()->get('language') == 'bangla'): ?> সমাধান <?php else: ?> Resolution <?php endif; ?></h5>
                            <p><?php if(session()->get('language') == 'bangla'): ?> ফার্মেসিকে কালো তালিকাভুক্ত করা বা কর্তৃপক্ষকে অবহিত করা হয়। <?php else: ?> Pharmacy is blacklisted or relevant authorities are notified. <?php endif; ?></p>
                        </div>
                    </div>
            ...
            <div class="col-md-8">
                <div class="umr-form-panel">
                    ...
                    <div class="umr-success-box">
                        ...
                        <div>
                            <h4><?php if(session()->get('language') == 'bangla'): ?> রিপোর্ট সফলভাবে জমা হয়েছে! <?php else: ?> Report Submitted Successfully! <?php endif; ?></h4>
                            <div class="tracking-chip"><?php echo e(session('tracking_number')); ?></div>
                            <p>
                                <?php if(session()->get('language') == 'bangla'): ?>
                    ...
                    <div class="umr-error-box">
                        <strong style="color:#721c24;">
                            <?php if(session()->get('language') == 'bangla'): ?> কিছু তথ্য সঠিক নয়: <?php else: ?> Please fix the following errors: <?php endif; ?>
                        </strong>
                        <ul>
                    ...
                    <h3>
                        <?php if(session()->get('language') == 'bangla'): ?> রিপোর্ট ফর্ম <?php else: ?> Report Form <?php endif; ?>
                    </h3>
                    <p class="subtitle">
                        <?php if(session()->get('language') == 'bangla'): ?>
                    ...
                    <form method="POST"
                          action="<?php echo e(route('unsafe.medicine.report.store')); ?>"
                        ...
                        <div class="umr-section-label">
                            ...
                            <?php if(session()->get('language') == 'bangla'): ?> প্রতিবেদনকারীর তথ্য (ঐচ্ছিক) <?php else: ?> Reporter Info (Optional) <?php endif; ?>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="reporter_name">
                                        <?php if(session()->get('language') == 'bangla'): ?> নাম <?php else: ?> Name <?php endif; ?>
                                        <span class="opt">(<?php if(session()->get('language') == 'bangla'): ?> ঐচ্ছিক <?php else: ?> optional <?php endif; ?>)</span>
                                    </label>
                                    <input type="text"
                                           name="reporter_name"
                                           id="reporter_name"
                                           value="<?php echo e(old('reporter_name')); ?>"
                                           class="form-control <?php echo e($errors->has('reporter_name') ? 'is-invalid' : ''); ?>"
                                           placeholder="<?php if(session()->get('language') == 'bangla'): ?> আপনার নাম <?php else: ?> Your full name <?php endif; ?>">
                                    <?php if($errors->has('reporter_name')): ?>
                                        <div class="invalid-feedback"><?php echo e($errors->first('reporter_name')); ?></div>
                                    <?php endif; ?>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="reporter_phone">
                                        <?php if(session()->get('language') == 'bangla'): ?> ফোন নম্বর <?php else: ?> Phone Number <?php endif; ?>
                                        <span class="opt">(<?php if(session()->get('language') == 'bangla'): ?> ঐচ্ছিক <?php else: ?> optional <?php endif; ?>)</span>
                                    </label>
                                    <input type="text"
                                           name="reporter_phone"
                                           id="reporter_phone"
                                           value="<?php echo e(old('reporter_phone')); ?>"
                                           class="form-control <?php echo e($errors->has('reporter_phone') ? 'is-invalid' : ''); ?>"
                                           placeholder="<?php if(session()->get('language') == 'bangla'): ?> ০১XXXXXXXXX <?php else: ?> 01XXXXXXXXX <?php endif; ?>">
                                    <?php if($errors->has('reporter_phone')): ?>
                                        <div class="invalid-feedback"><?php echo e($errors->first('reporter_phone')); ?></div>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="umr-section-label">
                            ...
                            <?php if(session()->get('language') == 'bangla'): ?> ওষুধের তথ্য <?php else: ?> Medicine Details <?php endif; ?>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="medicine_name">
                                        <?php if(session()->get('language') == 'bangla'): ?> ওষুধের নাম <?php else: ?> Medicine Name <?php endif; ?>
                                        <span class="req">*</span>
                                    </label>
                                    <input type="text"
                                           name="medicine_name"
                                           id="medicine_name"
                                           value="<?php echo e(old('medicine_name')); ?>"
                                           class="form-control <?php echo e($errors->has('medicine_name') ? 'is-invalid' : ''); ?>"
                                           placeholder="<?php if(session()->get('language') == 'bangla'): ?> যেমন: Napa 500mg <?php else: ?> e.g. Napa 500mg <?php endif; ?>"
                                           required>
                                    <?php if($errors->has('medicine_name')): ?>
                                        <div class="invalid-feedback"><?php echo e($errors->first('medicine_name')); ?></div>
                                    <?php endif; ?>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="batch_number">
                                        <?php if(session()->get('language') == 'bangla'): ?> ব্যাচ নম্বর <?php else: ?> Batch Number <?php endif; ?>
                                        <span class="opt">(<?php if(session()->get('language') == 'bangla'): ?> ঐচ্ছিক <?php else: ?> optional <?php endif; ?>)</span>
                                    </label>
                                    <input type="text"
                                           name="batch_number"
                                           ...
                                           class="form-control <?php echo e($errors->has('batch_number') ? 'is-invalid' : ''); ?>"
                                           placeholder="<?php if(session()->get('language') == 'bangla'): ?> প্যাকেটে উল্লেখিত ব্যাচ নম্বর <?php else: ?> Batch no. from the packet <?php endif; ?>">
                                    <?php if($errors->has('batch_number')): ?>
                                        <div class="invalid-feedback"><?php echo e($errors->first('batch_number')); ?></div>
                                    <?php endif; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="umr-section-label">
                            ...
                            <?php if(session()->get('language') == 'bangla'): ?> ফার্মেসির তথ্য <?php else: ?> Pharmacy Details <?php endif; ?>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="pharmacy_name">
                                        <?php if(session()->get('language') == 'bangla'): ?> ফার্মেসির নাম <?php else: ?> Pharmacy Name <?php endif; ?>
                                        <span class="req">*</span>
                                    </label>
                                    <input type="text"
                                           name="pharmacy_name"
                                           id="pharmacy_name"
                                           value="<?php echo e(old('pharmacy_name')); ?>"
                                           class="form-control <?php echo e($errors->has('pharmacy_name') ? 'is-invalid' : ''); ?>"
                                           placeholder="<?php if(session()->get('language') == 'bangla'): ?> ফার্মেসির নাম <?php else: ?> Pharmacy / drug store name <?php endif; ?>"
                                           required>
                                    <?php if($errors->has('pharmacy_name')): ?>
                                        <div class="invalid-feedback"><?php echo e($errors->first('pharmacy_name')); ?></div>
                                    <?php endif; ?>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="district">
                                        <?php if(session()->get('language') == 'bangla'): ?> জেলা <?php else: ?> District <?php endif; ?>
                                        <span class="req">*</span>
                                    </label>
                                    <select name="district"
                                            ...
                                            required>
                                        <option value="">— <?php if(session()->get('language') == 'bangla'): ?> জেলা নির্বাচন করুন <?php else: ?> Select District <?php endif; ?> —</option>
                                        <?php
                                            $districts = [
                                        ...
                                        <?php $__currentLoopData = $districts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($d); ?>" <?php echo e(old('district') == $d ? 'selected' : ''); ?>>
                                                <?php echo e($d); ?>
                        ...
                        <div class="form-group">
                            <label for="pharmacy_address">
                                <?php if(session()->get('language') == 'bangla'): ?> ফার্মেসির ঠিকানা <?php else: ?> Pharmacy Address <?php endif; ?>
                                <span class="req">*</span>
                            </label>
                            <textarea name="pharmacy_address"
                                      id="pharmacy_address"
                                      rows="2"
                                      class="form-control <?php echo e($errors->has('pharmacy_address') ? 'is-invalid' : ''); ?>"
                                      placeholder="<?php if(session()->get('language') == 'bangla'): ?> রাস্তা, এলাকা, উপজেলা <?php else: ?> Street, area, upazila <?php endif; ?>"
                                      required><?php echo e(old('pharmacy_address')); ?></textarea>
                            <?php if($errors->has('pharmacy_address')): ?>
                                <div class="invalid-feedback"><?php echo e($errors->first('pharmacy_address')); ?></div>
                            <?php endif; ?>
                        </div>
                        ...
                        <div class="umr-section-label">
                            ...
                            <?php if(session()->get('language') == 'bangla'): ?> সমস্যার বিবরণ <?php else: ?> Issue Description <?php endif; ?>
                        </div>

                        <div class="form-group">
                            <label for="description">
                                <?php if(session()->get('language') == 'bangla'): ?> বিস্তারিত বিবরণ <?php else: ?> Detailed Description <?php endif; ?>
                                <span class="req">*</span>
                            </label>
                            <textarea name="description"
                                      ...
                                      placeholder="<?php if(session()->get('language') == 'bangla'): ?> ওষুধটির কী সমস্যা লক্ষ্য করেছেন? প্যাকেজিং, গন্ধ, রঙ, কার্যকারিতা ইত্যাদি বর্ণনা করুন। <?php else: ?> Describe the problem: packaging, smell, colour, suspected counterfeiting, side effects observed, etc. <?php endif; ?>"
                        ...
                        <div class="umr-section-label">
                            ...
                            <?php if(session()->get('language') == 'bangla'): ?> প্রমাণ (ঐচ্ছিক) <?php else: ?> Evidence (Optional) <?php endif; ?>
                        </div>

                        
                        <div class="form-group">
                            <label>
                                <?php if(session()->get('language') == 'bangla'): ?> ছবি আপলোড <?php else: ?> Upload Images <?php endif; ?>
                                <span class="opt">(<?php if(session()->get('language') == 'bangla'): ?> সর্বোচ্চ ৫টি, প্রতিটি সর্বোচ্চ ৪ MB <?php else: ?> max 5 files, 4 MB each <?php endif; ?>)</span>
                            </label>
                            ...
                            <?php if($errors->has('images') || $errors->has('images.*')): ?>
                                <div class="invalid-feedback" style="display:block;">
                                    <?php echo e($errors->first('images') ?: $errors->first('images.*')); ?>
                        ...
                        <div class="form-group">
                            <label for="video">
                                <?php if(session()->get('language') == 'bangla'): ?> ইউটিউব ভিডিও লিংক <?php else: ?> YouTube Video Link <?php endif; ?>
                                <span class="opt">(<?php if(session()->get('language') == 'bangla'): ?> ঐচ্ছিক <?php else: ?> optional <?php endif; ?>)</span>
                            </label>
                            <div style="position:relative;">
                                ...
                                <input type="url"
                                       ...
                                       class="form-control <?php echo e($errors->has('video') ? 'is-invalid' : ''); ?>"
                                       style="padding-left: 34px;"
                                       placeholder="https://youtube.com/watch?v=...">
                            </div>
                            <?php if($errors->has('video')): ?>
                                <div class="invalid-feedback"><?php echo e($errors->first('video')); ?></div>
                            <?php endif; ?>
                        </div>
...
<?php echo $__env->make('frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\safe_medicine_toall\resources\views\frontend\unsafe_medicine_report\report_form.blade.php ENDPATH**/ ?>