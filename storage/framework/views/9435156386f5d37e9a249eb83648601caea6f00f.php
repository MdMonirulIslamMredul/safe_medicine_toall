    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-9 col-md-8 col-sm-6">
                <div class="row">
                    <?php $__empty_1 = true; $__currentLoopData = $subcategory->audios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $audio): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="col-lg-3 col-md-4">
                        <a href="<?php echo e(route('book.details', ['id' => $audio->id])); ?>">
                            <div class="custom_card" style="padding: 5px; border-radius: 20px; margin-bottom: 30px;">
                                <img src="<?php echo e(asset('thumbnails/')); ?>/<?php echo e($audio->thumbnil_img); ?>"
    ...
    <div class="col-lg-3 col-md-4 col-sm-6">
        <div class="custom_card" style="padding: 20px; border-radius: 20px; margin-bottom: 30px;">
            ...
            <div class="dropdown" style="margin: 2px 0">
                <button class="btn btn-success dropdown-toggle" style="width: 100%; text-align: left" type="button"
...
<?php echo $__env->make('frontend.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\safe_medicine_toall\resources\views\frontend\audio\subcategory_audio.blade.php ENDPATH**/ ?>