...
<?php $__env->startSection('body'); ?>
    <div class="row mt-2">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form class="form-horizontal" action="<?php echo e(route('tvcategories.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('category_name')); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('category_name_ban')); ?>">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('category_name_ab')); ?>">
                ...
                <table id="config-table" class="table display table-striped border no-wrap">
                    ...
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e($category->category_name??null); ?></td>
                            <td><?php echo e($category->category_name_ban??null); ?></td>
                            <td><?php echo e($category->category_name_ab??null); ?></td>
                            <td>
                                <div class="d-flex align-items-center">
                                    <div>
                                        <a href="<?php echo e(route('tvcategories.edit', $category->id)); ?>"
                                    ...
                                    <div>
                                        <form action="<?php echo e(route('tvcategories.destroy', $category->id)); ?>" method="POST">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\safe_medicine_toall\resources\views\admin\tv_category\tv_category.blade.php ENDPATH**/ ?>