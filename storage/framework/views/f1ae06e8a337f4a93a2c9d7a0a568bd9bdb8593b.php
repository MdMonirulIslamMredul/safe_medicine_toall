...
<div class="row mt-2">
    <div class="col-lg-12">
        <div class="card">            
            ...
            <div class="card-body">
                <form class="form-horizontal" action="<?php echo e(route('store.upcoming.project')); ?>" enctype="multipart/form-data" method="POST">
                    <?php echo csrf_field(); ?>
        ...
        <div class="card-header">
            <div class="table-responsive m-t-40">
                <table id="config-table" class="table display table-striped border">
                    ...
                    <tbody>
                    <?php $__currentLoopData = $upcome_project; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $upcome_project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td><img src="<?php echo e($upcome_project->image1 ?? null); ?>" style="height: 100px;"></td>
                            <td><?php echo e($upcome_project->title ?? null); ?></td>
                            <td><?php echo $upcome_project->short_des1 ?? null; ?></td>
                            <td>
                                <a href="<?php echo e(route('edit.upcome.porject',['id'=>$upcome_project->id])); ?>" class="btn btn-primary btn-sm editProduct">Edit</a>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\safe_medicine_toall\resources\views\admin\project\add_upcoming_project.blade.php ENDPATH**/ ?>