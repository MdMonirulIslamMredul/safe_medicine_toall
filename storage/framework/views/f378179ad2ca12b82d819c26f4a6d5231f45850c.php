  ...
  <style>
    ...
    width: 80px;">
            ...
            <ul class="menuzord-menu text-center" style="margin: 0 auto;">
              ...
              <li><a href="#"><?php if(session()->get('language') == 'bangla'): ?> ইউজার <?php elseif(session()->get('language')=='arabic'): ?> مستخدم <?php else: ?> User <?php endif; ?> </a>
                <ul class="dropdown">
                  <li class="text-left">
                    <a href="<?php echo e(route('unsafe.medicine.reports.index')); ?>">
                      <?php if(session()->get('language')=='bangla'): ?> মেডিসিন রিপোর্ট তালিকা <?php else: ?> Medicine Reports List <?php endif; ?>
                    </a>
                  </li>
                  <li class="text-left"><a href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault();
